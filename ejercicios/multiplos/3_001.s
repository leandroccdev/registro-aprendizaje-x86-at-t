...
_start:
    ...
    mov r13, N # Inicializa dividendo
    # ------------------------------------------------------

    _s_loop:
        mov rax, r12 # Inicializa dividendo (parte baja)
        xor rdx, rdx # Inicializa dividendo (parte alta)
        div r13 # RDX:RAX / R13
        # RAX: Cociente
        # RDX: Resto
        # ¿No es múltiplo de 3?
        ...
        # Convierte el dividendo a string y lo copia en un
        # el buffer row
        # --------------------------------------------------
        mov rdi, r12
        lea rsi, [row + 1]
        ...
        # Copia row en el buffer de salida bout
        # --------------------------------------------------
